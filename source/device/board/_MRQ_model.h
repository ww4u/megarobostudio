...
QString toString( MRQ_SYSTEM_DIOREFREAD eType );
...
QString toString( MRQ_MOTIONPLAN_PRESETSTATE eType );
...
int toValue( const QString &str, MRQ_SYSTEM_DIOREFREAD *pEVal );
...
int toValue( const QString &str, MRQ_MOTIONPLAN_PRESETSTATE *pEVal );
...
int setSYSTEM_DIOREFREAD( MRQ_SYSTEM_DIOREFREAD val0 );
int getSYSTEM_DIOREFREAD(  MRQ_SYSTEM_DIOREFREAD * val0, bool bQuery=true );
...
int setCAN_NETMANAGELED( MRQ_SYSTEM_DIOREFREAD val0 );
...
int setCLOCK_SYNCREGISTER( MRQ_SYSTEM_DIOREFREAD val0 );
int getCLOCK_SYNCREGISTER(  MRQ_SYSTEM_DIOREFREAD * val0, bool bQuery=true );
...
int getMOTION_OFFSETSTATE( byte val0, MRQ_SYSTEM_DIOREFREAD * val1, bool bQuery=true );
...
,MRQ_SYSTEM_DIOREFREAD val1 );
int getMOTION_REVMOTION( byte val0, MRQ_SYSTEM_DIOREFREAD * val1, bool bQuery=true );
...
int setIDENTITY_DISTDEVICE( MRQ_SYSTEM_DIOREFREAD val0 );
int getIDENTITY_DISTDEVICE(  MRQ_SYSTEM_DIOREFREAD * val0, bool bQuery=true );
...
,MRQ_MOTIONPLAN_PRESETSTATE val1, MRQ_MOTIONPLAN_PRESETSTATE_1 * val2, bool bQuery=true );
...
,MRQ_MOTION_SWITCH_1 val1, MRQ_SYSTEM_DIOREFREAD * val2, bool bQuery=true );
...
,MRQ_MOTION_SWITCH_1 val1, MRQ_MOTIONPLAN_OOSLINERESPONSE_1 * val2, bool bQuery=true );
int setPOSITION_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2
,f32 val3 );
int getPOSITION_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2, f32 * val3, bool bQuery=true );
int setVELOCITY_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2
,f32 val3 );
int getVELOCITY_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2, f32 * val3, bool bQuery=true );
int setTIME_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2
,f32 val3 );
int getTIME_( byte val0
,MRQ_MOTION_SWITCH_1 val1
,byte val2, f32 * val3, bool bQuery=true );
...
,MRQ_REPORT_STATE val1, MRQ_SYSTEM_DIOREFREAD * val2, bool bQuery=true );
...
,MRQ_SYSTEM_DIOREFREAD val1 );
int getTRIGGER_PATTSTATE( byte val0, MRQ_SYSTEM_DIOREFREAD * val1, bool bQuery=true );
...
,MRQ_TRIGGER_LEVELSTATE val1, MRQ_SYSTEM_DIOREFREAD * val2, bool bQuery=true );
...
,MRQ_SYSTEM_DIOREFREAD val1 );
int getDRIVER_STATE( byte val0, MRQ_SYSTEM_DIOREFREAD * val1, bool bQuery=true );
...
,MRQ_IDENTITY_LABEL_1 val1, MRQ_SYSTEM_DIOREFREAD * val2, bool bQuery=true );
...
int setISOLATORIN_STATE( MRQ_SYSTEM_DIOREFREAD val0 );
int getISOLATORIN_STATE(  MRQ_SYSTEM_DIOREFREAD * val0, bool bQuery=true );
...
public:
	...
	MRQ_SYSTEM_DIOREFREAD mSYSTEM_DIOREFREAD;
	...
	MRQ_SYSTEM_DIOREFREAD mCLOCK_SYNCREGISTER;
	MRQ_CLOCK_STARTTYPE mCLOCK_STARTTYPE;
	MRQ_CLOCK_SYNCSTATE mCLOCK_SYNCSTATE;
	uint32 mCLOCK_COUNT;

	MRQ_MOTION_STATE_2 mMOTION_STATE[4][10];
	...
	MRQ_SYSTEM_DIOREFREAD mMOTION_OFFSETSTATE[4];
	...
	MRQ_SYSTEM_DIOREFREAD mMOTION_REVMOTION[4];

	byte mIDENTITY_GROUP[4][2];
	MRQ_SYSTEM_DIOREFREAD mIDENTITY_DISTDEVICE;
	MRQ_IDENTITY_LABEL mIDENTITY_LABEL[4];
	MRQ_IDENTITY_LABEL_1 mIDENTITY_LABEL1[4];
	...
	byte mENCODER_FEEDBACKRATIO[4];
	MRQ_MOTIONPLAN_PVTCONFIG_1 mMOTIONPLAN_PVTCONFIG[4][10];
	MRQ_MOTIONPLAN_PRESETSTATE_1 mMOTIONPLAN_PRESETSTATE[4][10];

	MRQ_MOTIONPLAN_EXECUTEMODE_1 mMOTIONPLAN_EXECUTEMODE[4][10];
	MRQ_MOTIONPLAN_PLANMODE_1 mMOTIONPLAN_PLANMODE[4][10];
	MRQ_MOTIONPLAN_MOTIONMODE_1 mMOTIONPLAN_MOTIONMODE[4][10];
	MRQ_MOTIONPLAN_MODIFYDUTY_1 mMOTIONPLAN_MODIFYDUTY[4][10];

	uint16 mMOTIONPLAN_REMAINPOINT[4][10];
	uint32 mMOTIONPLAN_CYCLENUM[4][10];
	byte mMOTIONPLAN_WARNPOINT[4][10];
	MRQ_MOTIONPLAN_ENDSTATE_1 mMOTIONPLAN_ENDSTATE[4][10];

	uint32 mMOTIONPLAN_BUFFERSIZE[4][10];
	uint16 mMOTIONPLAN_ACCSCALE[4][10];
	uint16 mMOTIONPLAN_DECSCALE[4][10];
	MRQ_MOTIONPLAN_STOPMODE_1 mMOTIONPLAN_STOPMODE[4][10];

	f32 mMOTIONPLAN_STOPDISTANCE[4][10];
	f32 mMOTIONPLAN_STOPTIME[4][10];
	MRQ_SYSTEM_DIOREFREAD mMOTIONPLAN_OOSLINESTATE[4][10];
	uint16 mMOTIONPLAN_OOSLINEOUTNUM[4][10];

	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mMOTIONPLAN_OOSLINERESPONSE[4][10];
	MRQ_SYSTEM_DIOREFREAD mMOTIONPLAN_OOSTOTALSTATE[4][10];
	uint32 mMOTIONPLAN_OOSTOTALOUTNUM[4][10];
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mMOTIONPLAN_OOSTOTALRESPONSE[4][10];

	f32 mPOSITION_[4][10][4];
	f32 mVELOCITY_[4][10][4];
	f32 mTIME_[4][10][4];
	MRQ_SYSTEM_DIOREFREAD mREPORT_STATE[4][14];

	uint32 mREPORT_PERIOD[4][14];
	uint32 mREPORT_DATA[4][14];
	MRQ_TRIGGER_MODE mTRIGGER_MODE[4];
	MRQ_SYSTEM_DIOREFREAD mTRIGGER_PATTSTATE[4];

	MRQ_TRIGGER_PATTERN mTRIGGER_PATTERN[4];
	MRQ_TRIGGER_PATTERN mTRIGGER_PATTERN1[4];
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mTRIGGER_PATTRESP[4];
	MRQ_TRIGGER_PATTSMODE mTRIGGER_PATTSMODE[4];

	uint32 mTRIGGER_PATTSPERIOD[4];
	MRQ_SYSTEM_DIOREFREAD mTRIGGER_LEVELSTATE[4][2];
	MRQ_TRIGGER_LEVELTYPE_1 mTRIGGER_LEVELTYPE[4][2];
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mTRIGGER_LEVELRESP[4][2];

	MRQ_TRIGGER_PATTSMODE mTRIGGER_LEVELSMODE[4][2];
	f32 mTRIGGER_LEVELSPERIOD[4][2];
	...
	MRQ_SYSTEM_DIOREFREAD mDRIVER_STATE[4];
	MRQ_DRIVER_SGLIMIT mDRIVER_SGLIMIT[4];

	int8 mDRIVER_SGLIMIT1[4];
	int16 mDRIVER_SGPARASET[4][4];
	byte mDRIVER_IDLECURRENT[4];
	uint32 mDRIVER_SWITCHTIME[4];

	MRQ_DRIVER_MINICURRRATIO mDRIVER_MINICURRRATIO[4];
	...
	MRQ_SYSTEM_DIOREFREAD mSENSORUART_STATE[2][4];
	...
	MRQ_SYSTEM_DIOREFREAD mISOLATORIN_STATE;
