...
int robotH2::call( const tpvRegion &region )
{
    onLine();
...
int robotH2::program( QList<TraceKeyPoint> &curve,
...
int robotH2::move( QList<TraceKeyPoint> &curve,
                         const tpvRegion &region )
{
    int ret;
...
#define arm_lens( id1,id2,id3,id4,id5,id6 )     arm_len( id1 ),\
                                                ...
                                                arm_len( id5 ),\
                                                arm_len( id6 ),
int robotH2::nowPose( TraceKeyPoint &pos )
{
    //! get
    double angles[4];
...
int robotH2::nowDist( QList<float> &dists )
{
    //! get
    float dist;
    MegaDevice::deviceMRQ *pDev;
