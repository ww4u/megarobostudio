...
enum MRV_SYSTEM_TYPE_1{
	MRV_SYSTEM_TYPE_1_C23D,
	MRV_SYSTEM_TYPE_1_C23S,
	MRV_SYSTEM_TYPE_1_M2304,
	MRV_SYSTEM_TYPE_1_MV,
	MRV_SYSTEM_TYPE_1_M2310,
};
enum MRV_RS232_BAUD{
...
enum cmd_MRV
{
	...
	mc_SYSTEM = 2,
		...
		sc_SYSTEM_HARDVER_Q = 7,
		sc_SYSTEM_BOOTVER_Q = 8,
		sc_SYSTEM_ERROR_Q = 9,
		sc_SYSTEM_WARNCLEAR = 10,
	...
	mc_CAN = 4,
		...
		sc_CAN_NETMANAGESIGNATURE = 24,
		sc_CAN_NETMANAGESIGNATURE_Q = 25,
	...
	mc_GLOBAL = 22,
		sc_GLOBAL_GROUP = 0,
		sc_GLOBAL_GROUP_Q = 1,
		sc_GLOBAL_DISTINGUISH = 2,
		sc_GLOBAL_DISTINGUISH_Q = 3,

	mc_VALVECTRL = 51,
		sc_VALVECTRL_DEVICE = 0,
		sc_VALVECTRL_DEVICE_Q = 1,
		sc_VALVECTRL_PWMFREQ = 2,
		sc_VALVECTRL_PWMFREQ_Q = 3,
		sc_VALVECTRL_RTDUTY = 4,
		sc_VALVECTRL_RTDUTY_Q = 5,
		sc_VALVECTRL_ACTION = 6,
		sc_VALVECTRL_ACTION_Q = 7,
		sc_VALVECTRL_IDLEDUTY = 8,
		sc_VALVECTRL_IDLEDUTY_Q = 9,
		sc_VALVECTRL_HOLDDUTY = 10,
		sc_VALVECTRL_HOLDDUTY_Q = 11,
		sc_VALVECTRL_OPENDUTY = 12,
		sc_VALVECTRL_OPENDUTY_Q = 13,
		sc_VALVECTRL_OPENDLYTIME = 14,
		sc_VALVECTRL_OPENDLYTIME_Q = 15,
		sc_VALVECTRL_OPENTIME = 16,
		sc_VALVECTRL_OPENTIME_Q = 17,
		sc_VALVECTRL_RECORDSTATE = 18,
		sc_VALVECTRL_RECORDSTATE_Q = 19,
		sc_VALVECTRL_ONNUMS_Q = 20,
		sc_VALVECTRL_ONNUMSCLEAR = 21,
		sc_VALVECTRL_OFFNUMS_Q = 22,
		sc_VALVECTRL_OFFNUMSCLEAR = 23,
		sc_VALVECTRL_TIME_Q = 24,
		sc_VALVECTRL_TIMECLEAR = 25,

	mc_THRESHOLD = 52,
		sc_THRESHOLD_HIGHPRESSURE = 0,
		sc_THRESHOLD_HIGHPRESSURE_Q = 1,
		sc_THRESHOLD_HIPRESSUREACTION = 2,
		sc_THRESHOLD_HIPRESSUREACTION_Q = 3,
		sc_THRESHOLD_LOWPRESSURE = 4,
		sc_THRESHOLD_LOWPRESSURE_Q = 5,
		sc_THRESHOLD_LOWPRESSUREACTION = 6,
		sc_THRESHOLD_LOWPRESSUREACTION_Q = 7,
		sc_THRESHOLD_HIGHCURRENT = 8,
		sc_THRESHOLD_HIGHCURRENT_Q = 9,
		sc_THRESHOLD_HICURRENTACTION = 10,
		sc_THRESHOLD_HICURRENTACTION_Q = 11,
		sc_THRESHOLD_LOWCURRENT = 12,
		sc_THRESHOLD_LOWCURRENT_Q = 13,
		sc_THRESHOLD_LOWCURRENTACTION = 14,
		sc_THRESHOLD_LOWCURRENTACTION_Q = 15,
		sc_THRESHOLD_ONNUMS = 16,
		sc_THRESHOLD_ONNUMS_Q = 17,
		sc_THRESHOLD_NUMSACTION = 18,
		sc_THRESHOLD_NUMSACTION_Q = 19,
		sc_THRESHOLD_TIME = 20,
		sc_THRESHOLD_TIME_Q = 21,
		sc_THRESHOLD_TIMEACTION = 22,
		sc_THRESHOLD_TIMEACTION_Q = 23,
	...
	mc_CALIBRATION = 54,
		sc_CALIBRATION_TYPE = 0,
		sc_CALIBRATION_TYPE_Q = 1,
		sc_CALIBRATION_SAMPLERATE = 2,
		sc_CALIBRATION_SAMPLERATE_Q = 3,
		sc_CALIBRATION_OPENTIME = 4,
		sc_CALIBRATION_OPENTIME_Q = 5,
		sc_CALIBRATION_HOLDTIME = 6,
		sc_CALIBRATION_HOLDTIME_Q = 7,
		sc_CALIBRATION_CLOSETIME = 8,
		sc_CALIBRATION_CLOSETIME_Q = 9,
		sc_CALIBRATION_OPENDUTY = 10,
		sc_CALIBRATION_OPENDUTY_Q = 11,
		sc_CALIBRATION_HOLDDUTY = 12,
		sc_CALIBRATION_HOLDDUTY_Q = 13,
		sc_CALIBRATION_DATALENGTH_Q = 14,
		sc_CALIBRATION_DATAUPCTRL = 15,
		sc_CALIBRATION_DATAUP = 16,
	...
	mc_IOCONFIG = 56,
		sc_IOCONFIG_IOFUNCSEL = 0,
		sc_IOCONFIG_IOFUNCSEL_Q = 1,
		sc_IOCONFIG_SWFILTERDELAY = 2,
		sc_IOCONFIG_SWFILTERDELAY_Q = 3,
		sc_IOCONFIG_SWFILTERCOUNTER = 4,
		sc_IOCONFIG_SWFILTERCOUNTER_Q = 5,
		sc_IOCONFIG_TRIGEDGE = 6,
		sc_IOCONFIG_TRIGEDGE_Q = 7,
		sc_IOCONFIG_BAUD = 8,
		sc_IOCONFIG_BAUD_Q = 9,
		sc_IOCONFIG_WORDLEN = 10,
		sc_IOCONFIG_WORDLEN_Q = 11,
		sc_IOCONFIG_FLOWCTL = 12,
		sc_IOCONFIG_FLOWCTL_Q = 13,
		sc_IOCONFIG_PARITY = 14,
		sc_IOCONFIG_PARITY_Q = 15,
		sc_IOCONFIG_STOPBIT = 16,
		sc_IOCONFIG_STOPBIT_Q = 17,
		sc_IOCONFIG_APPLYPARA = 18,
};
#endif
