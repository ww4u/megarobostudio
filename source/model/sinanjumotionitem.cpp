...
//void SinanjuMotionItem::setItem( const QString &cmd, tpvType x, tpvType y, tpvType z, tpvType t )
//{
//    mCmd = cmd;
//    mX = x;
//    mY = y;
...
//    mT = t;
//}
//void SinanjuMotionItem::setCmd( const QString &cmd )
//{ mCmd = cmd; }

//void SinanjuMotionItem::setX( tpvType x )
//{ mX = x; }
//void SinanjuMotionItem::setY( tpvType y )
//{ mY = y; }
//void SinanjuMotionItem::setZ( tpvType z )
//{ mZ = z; }
//void SinanjuMotionItem::setT( tpvType t )
//{ mT = t; }

//void SinanjuMotionItem::setPara( tpvType x, tpvType y, tpvType z, tpvType t )
//{
//    mX = x;
//    mY = y;
//    mZ = z;
//    mT = t;
//}
//void SinanjuMotionItem::setComment( const QString &comment )
//{
//    mComment = comment;
//}

//QString SinanjuMotionItem::getCmd()
//{ return mCmd; }
//tpvType SinanjuMotionItem::getX()
//{ return mX; }
//tpvType SinanjuMotionItem::getY()
//{ return mY; }
//tpvType SinanjuMotionItem::getZ()
//{ return mZ; }
//tpvType SinanjuMotionItem::getT()
//{ return mT; }
//QString SinanjuMotionItem::getComment()
//{ return mComment; }
