...
QString toString( MRV_SYSTEM_TYPE_1 eType );
...
int toValue( const QString &str, MRV_SYSTEM_TYPE_1 *pEVal );
...
public:
	...
	MRV_SYSTEM_TYPE_1 mSYSTEM_TYPE1;
	...
	uint32 mVALVECTRL_OPENDLYTIME[10];

	uint32 mVALVECTRL_OPENTIME[10];
	...
	uint32 mTHRESHOLD_HIGHPRESSURE[10];
	MRV_THRESHOLD_HIPRESSUREACTION mTHRESHOLD_HIPRESSUREACTION[10];
	uint32 mTHRESHOLD_LOWPRESSURE[10];

	MRV_THRESHOLD_HIPRESSUREACTION mTHRESHOLD_LOWPRESSUREACTION[10];
	uint32 mTHRESHOLD_HIGHCURRENT[10];
	byte mTHRESHOLD_HICURRENTACTION;
	MRV_THRESHOLD_HIPRESSUREACTION mTHRESHOLD_HICURRENTACTION1;

	uint32 mTHRESHOLD_LOWCURRENT[10];
	byte mTHRESHOLD_LOWCURRENTACTION;
	MRV_THRESHOLD_HIPRESSUREACTION mTHRESHOLD_LOWCURRENTACTION1;
	...
	byte mIOCONFIG_STOPBIT;
	MRV_RS232_STOPBIT mIOCONFIG_STOPBIT1;
};
}
#endif
