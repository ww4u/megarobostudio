...
public:
	...
	MRQ_CAN_NETMANAGELED mTRIGGER_LEVELSTATE[10][2];
	MRQ_TRIGGER_LEVELTYPE_1 mTRIGGER_LEVELTYPE[10][2];
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mTRIGGER_LEVELRESP[10][2];
	MRQ_TRIGGER_PATTSMODE mTRIGGER_LEVELSMODE[10][2];

	f32 mTRIGGER_LEVELSPERIOD[10][2];
