...
int robotMegatron::move( QList<TraceKeyPoint> &curve )
{
    int ret;
...
#define arm_lens( id1,id2,id3,id4,id5,id6 )     arm_len( id1 ),\
                                                ...
                                                arm_len( id5 ),\
                                                arm_len( id6 ),
int robotMegatron::nowPose( TraceKeyPoint &pos )
{
    //! get
    double angles[4];
...
int robotMegatron::nowDist( QList<float> &dists )
{
    //! get
    float dist;
    MegaDevice::deviceMRQ *pDev;
