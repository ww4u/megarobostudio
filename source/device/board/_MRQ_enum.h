...
enum MRQ_LINK_DEVICEINFO_1{
	...
	MRQ_LINK_DEVICEINFO_1_M2302,
	MRQ_LINK_DEVICEINFO_1_M2304_1,
	MRQ_LINK_DEVICEINFO_1_MV_1,
};
...
enum MRQ_MOTION_SWITCH_1{
	...
	MRQ_MOTION_SWITCH_1_P9,
	MRQ_MOTION_SWITCH_1_P10,
	MRQ_MOTION_SWITCH_1_P11,
	MRQ_MOTION_SWITCH_1_P12,
	MRQ_MOTION_SWITCH_1_P13,
	MRQ_MOTION_SWITCH_1_P14,
	MRQ_MOTION_SWITCH_1_P15,
	MRQ_MOTION_SWITCH_1_P16,
	MRQ_MOTION_SWITCH_1_P17,
	MRQ_MOTION_SWITCH_1_P18,
	MRQ_MOTION_SWITCH_1_P19,
	MRQ_MOTION_SWITCH_1_P20,
	MRQ_MOTION_SWITCH_1_P21,
	MRQ_MOTION_SWITCH_1_P22,
};
...
enum MRQ_MOTIONPLAN_STOPMODE_1{
	...
	MRQ_MOTIONPLAN_STOPMODE_1_UNTILEND,
};
...
enum MRQ_TRIGGER_LEVELRESP_1{
	MRQ_TRIGGER_LEVELRESP_1_NONE,
	MRQ_TRIGGER_LEVELRESP_1_ALARM,
	MRQ_TRIGGER_LEVELRESP_1_STOP,
	MRQ_TRIGGER_LEVELRESP_1_ALARM_STOP,
	MRQ_TRIGGER_LEVELRESP_1_RUN,
};
...
enum MRQ_TUNING_CURRREGULATE{
	MRQ_TUNING_CURRREGULATE__1,
	MRQ_TUNING_CURRREGULATE__2,
	MRQ_TUNING_CURRREGULATE__4,
	MRQ_TUNING_CURRREGULATE__8,
};
enum MRQ_TUNING_CURRREGULATE_1{
	MRQ_TUNING_CURRREGULATE_1__32,
	MRQ_TUNING_CURRREGULATE_1__8,
	MRQ_TUNING_CURRREGULATE_1__2,
	MRQ_TUNING_CURRREGULATE_1__1,
};
...
enum cmd_MRQ
{
	...
	MRQ_mc_SYSTEM = 2,
		...
		MRQ_sc_SYSTEM_REVMOTION = 12,
		MRQ_sc_SYSTEM_REVMOTION_Q = 13,
		MRQ_sc_SYSTEM_FANPARA = 14,
		MRQ_sc_SYSTEM_FANPARA_Q = 15,
		MRQ_sc_SYSTEM_ARMLEDPARA = 16,
		MRQ_sc_SYSTEM_ARMLEDPARA_Q = 17,
	...
	MRQ_mc_MOTION = 21,
		...
		MRQ_sc_MOTION_ABCOUNTCLEAR = 32,
		MRQ_sc_MOTION_RUNTIMEL_Q = 33,
		MRQ_sc_MOTION_RUNTIMEH_Q = 34,
	...
	MRQ_mc_MOTIONPLAN = 53,
		...
		MRQ_sc_MOTIONPLAN_STOPMODE = 20,
		MRQ_sc_MOTIONPLAN_STOPMODE_Q = 21,
		MRQ_sc_MOTIONPLAN_STOPDISTANCE = 22,
		MRQ_sc_MOTIONPLAN_STOPDISTANCE_Q = 23,
		MRQ_sc_MOTIONPLAN_STOPTIME = 24,
		MRQ_sc_MOTIONPLAN_STOPTIME_Q = 25,
		MRQ_sc_MOTIONPLAN_OOSLINESTATE = 26,
		MRQ_sc_MOTIONPLAN_OOSLINESTATE_Q = 27,
		MRQ_sc_MOTIONPLAN_OOSLINEOUTNUM = 28,
		MRQ_sc_MOTIONPLAN_OOSLINEOUTNUM_Q = 29,
		MRQ_sc_MOTIONPLAN_OOSLINERESPONSE = 30,
		MRQ_sc_MOTIONPLAN_OOSLINERESPONSE_Q = 31,
		MRQ_sc_MOTIONPLAN_OOSTOTALSTATE = 32,
		MRQ_sc_MOTIONPLAN_OOSTOTALSTATE_Q = 33,
		MRQ_sc_MOTIONPLAN_OOSTOTALOUTNUM = 34,
		MRQ_sc_MOTIONPLAN_OOSTOTALOUTNUM_Q = 35,
		MRQ_sc_MOTIONPLAN_OOSTOTALRESPONSE = 36,
		MRQ_sc_MOTIONPLAN_OOSTOTALRESPONSE_Q = 37,
		MRQ_sc_MOTIONPLAN_FIFOBUFFERTIME = 38,
		MRQ_sc_MOTIONPLAN_FIFOBUFFERTIME_Q = 39,
	...
	MRQ_mc_TRIGGER = 71,
		...
		MRQ_sc_TRIGGER_LEVELRUNWAVE = 22,
		MRQ_sc_TRIGGER_LEVELRUNWAVE_Q = 23,
	...
	MRQ_mc_TUNING = 76,
		MRQ_sc_TUNING_STATE = 0,
		MRQ_sc_TUNING_STATE_Q = 1,
		MRQ_sc_TUNING_MINICURRRATIO = 2,
		MRQ_sc_TUNING_MINICURRRATIO_Q = 3,
		MRQ_sc_TUNING_ENERGYEFFIC = 4,
		MRQ_sc_TUNING_ENERGYEFFIC_Q = 5,
		MRQ_sc_TUNING_CURRREGULATE = 6,
		MRQ_sc_TUNING_CURRREGULATE_Q = 7,

	MRQ_mc_ISOLATORIN = 92,
