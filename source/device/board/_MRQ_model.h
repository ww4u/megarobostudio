...
QString toString( MRQ_TRIGGER_LEVELRESP_1 eType );
...
QString toString( MRQ_TUNING_CURRREGULATE eType );
QString toString( MRQ_TUNING_CURRREGULATE_1 eType );
...
int toValue( const QString &str, MRQ_TRIGGER_LEVELRESP_1 *pEVal );
...
int toValue( const QString &str, MRQ_TUNING_CURRREGULATE *pEVal );
int toValue( const QString &str, MRQ_TUNING_CURRREGULATE_1 *pEVal );
...
public:
	...
	char mSYSTEM_SOFTVER3;
	char mSYSTEM_FPGAVER;
	char mSYSTEM_FPGAVER1;

	char mSYSTEM_FPGAVER2;
	char mSYSTEM_FPGAVER3;
	char mSYSTEM_FPGAVER4;
	char mSYSTEM_FPGAVER5;
	...
	MRQ_SYSTEM_REVMOTION mSYSTEM_REVMOTION;
	...
	MRQ_SYSTEM_REVMOTION mCLOCK_SYNCREGISTER;

	MRQ_CLOCK_STARTTYPE mCLOCK_STARTTYPE;
	MRQ_CLOCK_SYNCSTATE mCLOCK_SYNCSTATE;
	uint32 mCLOCK_COUNT;
	MRQ_MOTION_STATE_2 mMOTION_STATE[10][24];
	...
	MRQ_SYSTEM_REVMOTION mMOTION_OFFSETSTATE[10];
	int16 mMOTION_COUNTCIRCLE[10];
	int32 mMOTION_ABCOUNT[10];
	uint32 mMOTION_RUNTIMEL[10];

	uint32 mMOTION_RUNTIMEH[10];
	byte mIDENTITY_GROUP[10][2];
	MRQ_SYSTEM_REVMOTION mIDENTITY_DISTDEVICE;
	...
	MRQ_MOTIONPLAN_PVTCONFIG_1 mMOTIONPLAN_PVTCONFIG[10][24];
	MRQ_MOTIONPLAN_PRESETSTATE_1 mMOTIONPLAN_PRESETSTATE[10][24];
	MRQ_MOTIONPLAN_EXECUTEMODE_1 mMOTIONPLAN_EXECUTEMODE[10][24];
	MRQ_MOTIONPLAN_PLANMODE_1 mMOTIONPLAN_PLANMODE[10][24];

	MRQ_MOTIONPLAN_MOTIONMODE_1 mMOTIONPLAN_MOTIONMODE[10][24];
	MRQ_MOTIONPLAN_MODIFYDUTY_1 mMOTIONPLAN_MODIFYDUTY[10][24];
	uint16 mMOTIONPLAN_REMAINPOINT[10][24];
	uint32 mMOTIONPLAN_CYCLENUM[10][24];

	byte mMOTIONPLAN_WARNPOINT[10][24];
	MRQ_MOTIONPLAN_ENDSTATE_1 mMOTIONPLAN_ENDSTATE[10][24];
	uint32 mMOTIONPLAN_BUFFERSIZE[10][24];
	MRQ_MOTIONPLAN_STOPMODE_1 mMOTIONPLAN_STOPMODE[10][24];

	f32 mMOTIONPLAN_STOPDISTANCE[10][24];
	f32 mMOTIONPLAN_STOPTIME[10][24];
	MRQ_SYSTEM_REVMOTION mMOTIONPLAN_OOSLINESTATE[10][24];
	uint16 mMOTIONPLAN_OOSLINEOUTNUM[10][24];

	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mMOTIONPLAN_OOSLINERESPONSE[10][24];
	MRQ_SYSTEM_REVMOTION mMOTIONPLAN_OOSTOTALSTATE[10][24];
	uint32 mMOTIONPLAN_OOSTOTALOUTNUM[10][24];
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mMOTIONPLAN_OOSTOTALRESPONSE[10][24];

	uint32 mMOTIONPLAN_FIFOBUFFERTIME[10][24];
	f32 mPOSITION[10][24][10];
	f32 mVELOCITY[10][24][10];
	f32 mTIME[10][24][10];

	uint16 mTIMESCALE[10][24][10];
	uint16 mTIMESCALE1[10][24][10];
	MRQ_SYSTEM_REVMOTION mREPORT_STATE[10][6];
	uint32 mREPORT_PERIOD[10][6];

	uint32 mREPORT_DATA[10][6];
	MRQ_TRIGGER_MODE mTRIGGER_MODE[10];
	MRQ_SYSTEM_REVMOTION mTRIGGER_PATTSTATE[10];
	...
	MRQ_SYSTEM_REVMOTION mTRIGGER_LEVELSTATE[10][5];
	MRQ_TRIGGER_LEVELTYPE_1 mTRIGGER_LEVELTYPE[10][5];
	MRQ_TRIGGER_LEVELRESP_1 mTRIGGER_LEVELRESP[10][5];
	MRQ_TRIGGER_PATTSMODE mTRIGGER_LEVELSMODE[10][5];

	f32 mTRIGGER_LEVELSPERIOD[10][5];
	MRQ_MOTION_SWITCH_1 mTRIGGER_LEVELRUNWAVE[10][5];
	...
	MRQ_SYSTEM_REVMOTION mDRIVER_STATE[10];
	...
	MRQ_SYSTEM_REVMOTION mSENSORUART_STATE[2][4];
	...
	MRQ_SYSTEM_REVMOTION mTUNING_STATE[10];

	MRQ_DRIVER_MINICURRRATIO mTUNING_MINICURRRATIO[10];
	uint16 mTUNING_ENERGYEFFIC[10];
	uint16 mTUNING_ENERGYEFFIC1[10];
	MRQ_TUNING_CURRREGULATE mTUNING_CURRREGULATE[10];

	MRQ_TUNING_CURRREGULATE_1 mTUNING_CURRREGULATE1[10];
	MRQ_SYSTEM_REVMOTION mISOLATORIN_STATE;
	...
	MRQ_SYSTEM_REVMOTION mABSENCALARM_STATE[4];

	int32 mABSENCALARM_UPLIMIT[4];
	int32 mABSENCALARM_DOWNLIMIT[4];
	...
	MRQ_SYSTEM_REVMOTION mDISTANCEALARM_STATE[4];
	...
	MRQ_SYSTEM_REVMOTION mNEWDRIVER_STATE[10];
	MRQ_CLOCK_SYNCSTATE mPDM_SAMPLESTATE[10];
	byte mPDM_ENCDIV[10];
	uint16 mPDM_MICSTEPCOUNT[10];

	byte mPDM_MICSTEPDATA[10][10][10];
	MRQ_SYSTEM_REVMOTION mOTP_STATE;
	uint16 mOTP_THRESHOLD;
	MRQ_MOTIONPLAN_OOSLINERESPONSE_1 mOTP_RESPONSE;

	uint32 mOTP_PERIOD;
	uint32 mOTP_DATA;
	MRQ_SYSTEM_REVMOTION mANALOGIN_STATE;
