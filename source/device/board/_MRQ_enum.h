...
enum MRQ_MOTIONPLAN_PLANMODE_1{
	...
	MRQ_MOTIONPLAN_PLANMODE_1_LINEAR,
	MRQ_MOTIONPLAN_PLANMODE_1_UNIFORM,
...
enum MRQ_MOTIONPLAN_MODIFYDUTY_1{
	MRQ_MOTIONPLAN_MODIFYDUTY_1__1_4,
	MRQ_MOTIONPLAN_MODIFYDUTY_1__1_8,
	MRQ_MOTIONPLAN_MODIFYDUTY_1__1_16,
	MRQ_MOTIONPLAN_MODIFYDUTY_1__1_32,
};
...
enum cmd_MRQ
{
	...
	mc_SYSTEM = 2,
		...
		sc_SYSTEM_EVENTCODE_Q = 10,
		sc_SYSTEM_DIOSTATE_Q = 11,
		sc_SYSTEM_FANPARA = 12,
		sc_SYSTEM_FANPARA_Q = 13,
		sc_SYSTEM_ARMLEDPARA = 14,
		sc_SYSTEM_ARMLEDPARA_Q = 15,
	...
	mc_MOTION = 21,
		...
		sc_MOTION_OFFSETSTATE = 27,
		sc_MOTION_OFFSETSTATE_Q = 28,
		sc_MOTION_OFFSET = 29,
		sc_MOTION_COUNTCIRCLE_Q = 30,
		sc_MOTION_ABCOUNT_Q = 31,
		sc_MOTION_REVMOTION = 32,
		sc_MOTION_REVMOTION_Q = 33,
		sc_MOTION_ABCOUNTRESET = 34,
	...
	mc_ENCODER = 52,
		...
		sc_ENCODER_FEEDBACKRATIO = 10,
		sc_ENCODER_FEEDBACKRATIO_Q = 11,

	mc_MOTIONPLAN = 53,
		sc_MOTIONPLAN_PVTCONFIG = 0,
		sc_MOTIONPLAN_PVTCONFIG_Q = 1,
		sc_MOTIONPLAN_PRESETSTATE = 2,
		sc_MOTIONPLAN_PRESETSTATE_Q = 3,
		sc_MOTIONPLAN_EXECUTEMODE = 4,
		sc_MOTIONPLAN_EXECUTEMODE_Q = 5,
		sc_MOTIONPLAN_PLANMODE = 6,
		sc_MOTIONPLAN_PLANMODE_Q = 7,
		sc_MOTIONPLAN_MOTIONMODE = 8,
		sc_MOTIONPLAN_MOTIONMODE_Q = 9,
		sc_MOTIONPLAN_MODIFYDUTY = 10,
		sc_MOTIONPLAN_MODIFYDUTY_Q = 11,
		sc_MOTIONPLAN_REMAINPOINT_Q = 12,
		sc_MOTIONPLAN_CYCLENUM = 13,
		sc_MOTIONPLAN_CYCLENUM_Q = 14,
		sc_MOTIONPLAN_WARNPOINT = 15,
		sc_MOTIONPLAN_WARNPOINT_Q = 16,
		sc_MOTIONPLAN_ENDSTATE = 17,
		sc_MOTIONPLAN_ENDSTATE_Q = 18,
		sc_MOTIONPLAN_BUFFERSIZE_Q = 19,
		sc_MOTIONPLAN_ACCSCALE = 20,
		sc_MOTIONPLAN_ACCSCALE_Q = 21,
		sc_MOTIONPLAN_DECSCALE = 22,
		sc_MOTIONPLAN_DECSCALE_Q = 23,
		sc_MOTIONPLAN_STOPMODE = 24,
		sc_MOTIONPLAN_STOPMODE_Q = 25,
		sc_MOTIONPLAN_STOPDISTANCE = 26,
		sc_MOTIONPLAN_STOPDISTANCE_Q = 27,
		sc_MOTIONPLAN_STOPTIME = 28,
		sc_MOTIONPLAN_STOPTIME_Q = 29,
		sc_MOTIONPLAN_OOSLINESTATE = 30,
		sc_MOTIONPLAN_OOSLINESTATE_Q = 31,
		sc_MOTIONPLAN_OOSLINEOUTNUM = 32,
		sc_MOTIONPLAN_OOSLINEOUTNUM_Q = 33,
		sc_MOTIONPLAN_OOSLINERESPONSE = 34,
		sc_MOTIONPLAN_OOSLINERESPONSE_Q = 35,
		sc_MOTIONPLAN_OOSTOTALSTATE = 36,
		sc_MOTIONPLAN_OOSTOTALSTATE_Q = 37,
		sc_MOTIONPLAN_OOSTOTALOUTNUM = 38,
		sc_MOTIONPLAN_OOSTOTALOUTNUM_Q = 39,
		sc_MOTIONPLAN_OOSTOTALRESPONSE = 40,
		sc_MOTIONPLAN_OOSTOTALRESPONSE_Q = 41,
	...
	mc_DRIVER = 62,
		...
		sc_DRIVER_STATE_Q = 7,
		sc_DRIVER_SGLIMIT = 8,
		sc_DRIVER_SGLIMIT_Q = 9,
		sc_DRIVER_SGPARASET = 10,
		sc_DRIVER_SGPARASET_Q = 11,
		sc_DRIVER_IDLECURRENT = 12,
		sc_DRIVER_IDLECURRENT_Q = 13,
		sc_DRIVER_SWITCHTIME = 14,
		sc_DRIVER_SWITCHTIME_Q = 15,
		sc_DRIVER_MINICURRRATIO = 16,
		sc_DRIVER_MINICURRRATIO_Q = 17,
		sc_DRIVER_REGCONFIG = 18,
		sc_DRIVER_REGCONFIG_Q = 19,

	mc_DIGITALOUTPUT = 63,
		sc_DIGITALOUTPUT_STATE = 0,
		sc_DIGITALOUTPUT_STATE_Q = 1,
		sc_DIGITALOUTPUT_SIGNAL = 2,
		sc_DIGITALOUTPUT_SIGNAL_Q = 3,
		sc_DIGITALOUTPUT_POLARITY = 4,
		sc_DIGITALOUTPUT_POLARITY_Q = 5,
		sc_DIGITALOUTPUT_SOURCE = 6,
		sc_DIGITALOUTPUT_SOURCE_Q = 7,
		sc_DIGITALOUTPUT_CONDITION = 8,
		sc_DIGITALOUTPUT_CONDITION_Q = 9,
		sc_DIGITALOUTPUT_PERIOD = 10,
		sc_DIGITALOUTPUT_PERIOD_Q = 11,
		sc_DIGITALOUTPUT_DUTY = 12,
		sc_DIGITALOUTPUT_DUTY_Q = 13,

	mc_ISOLATOROUTPUT = 64,
	...
	mc_ABSENCALARM = 73,
		sc_ABSENCALARM_STATE = 0,
		sc_ABSENCALARM_STATE_Q = 1,
		sc_ABSENCALARM_UPLIMIT = 2,
		sc_ABSENCALARM_UPLIMIT_Q = 3,
		sc_ABSENCALARM_DOWNLIMIT = 4,
		sc_ABSENCALARM_DOWNLIMIT_Q = 5,
		sc_ABSENCALARM_ZEROVALUE = 6,
		sc_ABSENCALARM_ZEROVALUE_Q = 7,
		sc_ABSENCALARM_ZEROPOSITION = 8,
		sc_ABSENCALARM_ZEROPOSITION_Q = 9,
		sc_ABSENCALARM_RESPONSE = 10,
		sc_ABSENCALARM_RESPONSE_Q = 11,

	mc_DISTANCEALARM = 74,
		sc_DISTANCEALARM_STATE = 0,
		sc_DISTANCEALARM_STATE_Q = 1,
		sc_DISTANCEALARM_ALARM1DIST = 2,
		sc_DISTANCEALARM_ALARM1DIST_Q = 3,
		sc_DISTANCEALARM_ALARM2DIST = 4,
		sc_DISTANCEALARM_ALARM2DIST_Q = 5,
		sc_DISTANCEALARM_ALARM3DIST = 6,
		sc_DISTANCEALARM_ALARM3DIST_Q = 7,

	mc_OTP = 70,
		sc_OTP_STATE = 0,
		sc_OTP_STATE_Q = 1,
		sc_OTP_THRESHOLD = 2,
		sc_OTP_THRESHOLD_Q = 3,
		sc_OTP_RESPONSE = 4,
		sc_OTP_RESPONSE_Q = 5,
		sc_OTP_PERIOD = 6,
		sc_OTP_PERIOD_Q = 7,
	...
	mc_ANALOGIN = 71,
		sc_ANALOGIN_STATE = 0,
		sc_ANALOGIN_STATE_Q = 1,
		sc_ANALOGIN_THRESHOLDH = 2,
		sc_ANALOGIN_THRESHOLDH_Q = 3,
		sc_ANALOGIN_THRESHOLDL = 4,
		sc_ANALOGIN_THRESHOLDL_Q = 5,
		sc_ANALOGIN_RESPONSEH = 6,
		sc_ANALOGIN_RESPONSEH_Q = 7,
		sc_ANALOGIN_RESPONSEL = 8,
		sc_ANALOGIN_RESPONSEL_Q = 9,

	mc_NEWDRIVER = 75,
		sc_NEWDRIVER_TYPE_Q = 0,
		sc_NEWDRIVER_CURRENT = 1,
		sc_NEWDRIVER_CURRENT_Q = 2,
		sc_NEWDRIVER_MICROSTEPS = 3,
		sc_NEWDRIVER_MICROSTEPS_Q = 4,
		sc_NEWDRIVER_STATE = 5,
		sc_NEWDRIVER_STATE_Q = 6,
};
#endif
