...
public:
MRV();
int setLINK_INTFC( MRV_LINK_INTFC val0 , bool bDiff=false );
...
int setSYSTEM_WORKMODE( MRV_SYSTEM_WORKMODE val0 , bool bDiff=false );
int getSYSTEM_WORKMODE(  MRV_SYSTEM_WORKMODE * val0, bool bQuery=true );
int setSYSTEM_POWERON( MRV_SYSTEM_POWERON val0 , bool bDiff=false );
...
int setSYSTEM_WARNCLEAR( byte val0 , bool bDiff=false );
int setRS232_BAUD( MRV_RS232_BAUD val0 , bool bDiff=false );
int getRS232_BAUD(  MRV_RS232_BAUD * val0, bool bQuery=true );
int setRS232_WORDLEN( MRV_RS232_WORDLEN val0 , bool bDiff=false );
int getRS232_WORDLEN(  MRV_RS232_WORDLEN * val0, bool bQuery=true );
int setRS232_FLOWCTL( MRV_RS232_FLOWCTL val0 , bool bDiff=false );
int getRS232_FLOWCTL(  MRV_RS232_FLOWCTL * val0, bool bQuery=true );
int setRS232_PARITY( MRV_RS232_PARITY val0 , bool bDiff=false );
int getRS232_PARITY(  MRV_RS232_PARITY * val0, bool bQuery=true );
int setRS232_STOPBIT( MRV_RS232_STOPBIT val0 , bool bDiff=false );
int getRS232_STOPBIT(  MRV_RS232_STOPBIT * val0, bool bQuery=true );
int setRS232_APPLYPARA(    bool bDiff=false );
int setCAN_TYPE( MRV_CAN_TYPE val0 , bool bDiff=false );
int getCAN_TYPE(  MRV_CAN_TYPE * val0, bool bQuery=true );
int setCAN_BAUD( MRV_CAN_BAUD val0 , bool bDiff=false );
...
int setCAN_NETMANAGELED( MRV_CAN_NETMANAGELED val0 , bool bDiff=false );
int setCAN_NETMANAGESTATE( MRV_CAN_NETMANAGESTATE val0 , bool bDiff=false );
int getCAN_NETMANAGESTATE(  MRV_CAN_NETMANAGESTATE * val0, bool bQuery=true );
int setCAN_NETMANAGEID( uint32 val0 , bool bDiff=false );
...
,MRV_MOTION_STATEREPORT val1 , bool bDiff=false );
...
,MRV_VALVECTRL_ACTION val1 , bool bDiff=false );
...
int setVALVECTRL_ONNUMSCLEAR( byte val0 , bool bDiff=false );
int getVALVECTRL_OFFNUMS( byte val0, uint32 * val1, bool bQuery=true );
int setVALVECTRL_OFFNUMSCLEAR( byte val0 , bool bDiff=false );
int getVALVECTRL_TIME( byte val0, uint32 * val1, bool bQuery=true );
int setVALVECTRL_TIMECLEAR( byte val0 , bool bDiff=false );
...
,MRV_THRESHOLD_HIPRESSUREACTION val1 , bool bDiff=false );
...
,MRV_PVT_EXECMODE val1 , bool bDiff=false );
int getPVT_EXECMODE( byte val0, MRV_PVT_EXECMODE * val1, bool bQuery=true );
int setPVT_RESET( byte val0 , bool bDiff=false );
...
int setPVT_START( byte val0 , bool bDiff=false );
int getPVT_START(  byte * val0, bool bQuery=true );
int setPVT_END( byte val0 , bool bDiff=false );
...
,MRV_IOCONFIG_IOFUNCSEL val1 , bool bDiff=false );
