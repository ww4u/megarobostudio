...
public:
	...
	MRQ_SYSTEM_REPORTSWITCH mTRIGGER_LEVELSTATE[4][2];
	MRQ_TRIGGER_LEVELTYPE_1 mTRIGGER_LEVELTYPE[4][2];
	MRQ_OUTOFSTEP_LINERESPONSE mTRIGGER_LEVELRESP[4][2];
	...
	MRQ_DIGITALOUT_STATE_1 mDIGITALOUT_STATE[4];
	MRQ_DIGITALOUT_SIGNAL_1 mDIGITALOUT_SIGNAL[4];

	MRQ_DIGITALOUT_POLARITY_1 mDIGITALOUT_POLARITY[4];
	byte mDIGITALOUT_SOURCE[4];
	MRQ_DIGITALOUT_CONDITION_1 mDIGITALOUT_CONDITION[4];
	uint32 mDIGITALOUT_PERIOD[4];

	uint16 mDIGITALOUT_DUTY[4];
	...
	MRQ_SYSTEM_REPORTSWITCH mSENSORUART_STATE[2][4];
	...
	MRQ_SYSTEM_REPORTSWITCH mISOLATORIN_STATE;
	MRQ_TRIGGER_LEVELTYPE_1 mISOLATORIN_TYPE;
	MRQ_OUTOFSTEP_LINERESPONSE mISOLATORIN_RESPONSE;
