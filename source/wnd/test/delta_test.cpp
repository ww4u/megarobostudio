...
//    points.append( pt );
    ...
    ret = arith_delta::slove( points, deltaPoints );
    logDbg()<<ret;
    ...
    {
        logDbg()<<deltaPoints.at(i).t
                <<deltaPoints.at(i).p[0]
                <<deltaPoints.at(i).p[1]
                <<deltaPoints.at(i).p[2]
                <<deltaPoints.at(i).v[0]
                <<deltaPoints.at(i).v[1]
                <<deltaPoints.at(i).v[2]
                <<deltaPoints.at(i).a[0]
                <<deltaPoints.at(i).a[1]
                <<deltaPoints.at(i).a[2];
    }
}
...
//    QString strFile( "G:/work/mc/develope/installer/package/dataset/delta.csv" );
    ...
    for ( int i = 0; i <deltaPoints.size(); i++ )
    {
        logDbg()<<i
                <<deltaPoints.at(i).t
                <<deltaPoints.at(i).p[0]<<deltaPoints.at(i).p[1]<<deltaPoints.at(i).p[2]
                <<deltaPoints.at(i).v[0]<<deltaPoints.at(i).v[1]<<deltaPoints.at(i).v[2]
